...
- Pumps-and-dump, money-doubling schemes, financial advisor / trader strategy / frontrun bot testimonials with direct links, and other financial scams, especially when they include a link, or ask to search random symbols on telegram.
- Job offers that are not related to the channel and offer high salaries for beta testers or moderators.
