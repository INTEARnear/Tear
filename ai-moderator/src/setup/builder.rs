...
- Promotion of airdrops or claims with a link, especially if has a [markdown](link), contains excessive emojis, or if the project is not even remotely related to NEAR or the chat you're moderating. Allow airdrops of reputable projects or if the project has the same name as the telegram chat.
